...
* $S_{gen}$ benchmark when alpha < 2.5 (Holt et al. 2018) (Fig. \@ref(fig:Sgen-alpha))
...
```{r SMSY-alpha, fig.cap="SMSY values for given combinations of alpha and beta for a Ricker model", echo=FALSE}
