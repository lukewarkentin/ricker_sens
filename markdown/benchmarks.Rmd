---
title: "Potential issues with fixed escapement goals and benchmarks based on stock-recruit models, in scenarios of variable and low productivity"
...
* $S_{gen}$ benchmark when there is harvest, especially uncertain harvest


```{r Sgen-alpha, fig.cap="Sgen values for given combinations of alpha and beta for a Ricker model", echo=FALSE}
knitr::include_graphics(here('figures/fig_Sgen~alpha.png'))
```
